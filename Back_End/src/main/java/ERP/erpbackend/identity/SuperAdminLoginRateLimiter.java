...
@Component
class SuperAdminLoginRateLimiter {

	private static final String KEY_PREFIX = "ratelimit:superadmin-login:";
	private static final int MAX_ATTEMPTS = 5;
	private static final Duration WINDOW = Duration.ofMinutes(10);

	private final IpRateLimiter limiter;

	SuperAdminLoginRateLimiter(StringRedisTemplate redisTemplate) {
